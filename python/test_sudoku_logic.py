...
class SudokuLogicTests(unittest.TestCase):
    ...
    def test_eliminate_hidden_sets__hidden_set_1_6_in_col7__eliminates_with_hidden(self):
        bit_table = [ 32,   6, 258,  404, 138, 268,    1,  64,  24,
                      64,   7, 259,  276,  10,  32,  128, 260,  24,
                       8, 128,  16,    1,  64, 260,    2, 260,  32,
        ...
        exp_table = [ 32,   6, 258,  404, 138, 268,    1,  64,  24,
                      64,   7, 259,  276,  10,  32,  128, 260,  24,
                       8, 128,  16,    1,  64, 260,    2, 260,  32,
                     ...
                     129, 257,   4,  384,  33,  16,   40,   2,  64,
                     145,  65,   8,    2,  33,  68,   52, 144, 256,
                     146, 322,  32,  388, 136, 332,   28, 152,   1]

        result = eliminate_with_hidden_sets(bit_table, [{ "box_ix": 7, "values": [1, 6], "cell_ixs": [58, 67] }])
        self.assertEqual(exp_table, result)